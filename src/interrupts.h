...
protected:
    ...
    Port_8_Slow programmableInterruptControllerMasterCommandPort;
    Port_8_Slow programmableInterruptControllerMasterDataPort;
    Port_8_Slow programmableInterruptControllerSlaveCommandPort;
    Port_8_Slow programmableInterruptControllerSlaveDataPort;
