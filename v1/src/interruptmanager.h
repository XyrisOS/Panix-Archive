...
protected:
     ...
     * @param mgr Active manager for interrupts
     * @return Constructed InterruptHandler object
     */
    InterruptHandler(uint8_t num, InterruptManager * mgr);

    /**
     * Deconstructor for the InterruptHandler class
     */
    ~InterruptHandler();
public:

    /**
     * Handles a given interrupt.
     * @param esp
     * @return 
     */
